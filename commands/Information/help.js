    ...
    try {
      ...
      if (!commandopt) {
        ...
        let button_tutorial = new MessageButton()
          ...
          .setLabel(`Tutorial`)
          .setURL(`https://www.youtube.com/channel/UCKDhgFpHukSUlL7XS5grbNQ`);
        ...
        let embed = new MessageEmbed()
          ...
          .addField(
            `** Developer Info **`,
            `** Name : <@924403277083324416> | [Youtube](https://www.youtube.com/channel/UCKDhgFpHukSUlL7XS5grbNQ) | [Github](https://github.com/Calin-engine) | [Plist](https://replit.com/@CalinEngine/JUGNU-MUSIC-2#commands/Music/playmix.js)**`
          );
        await interaction
          .followUp({
            embeds: [embed],
